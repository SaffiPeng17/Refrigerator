...
//                 "Sausage", "Milk", "Black Tea", "Curry", "Spaghetti", "Juice"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //Setup cell
        cell.fName.text = foods[indexPath.row]
        cell.fImage.image = UIImage(named: foodimgs[indexPath.row])
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        let share = UITableViewRowAction(style: .default, title: "Share") { (action, indexPath) in
            if let shareImage = UIImage(named: self.foodimgs[indexPath.row]) {
                let shareText = self.foods[indexPath.row]
